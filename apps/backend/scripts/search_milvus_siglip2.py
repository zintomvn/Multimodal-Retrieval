...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Search vectors in Zilliz/Milvus with an OpenAI-compatible embedding endpoint.")
...
def hit_to_dict(hit: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "model_key": entity.get("model_key"),
        "model_name": entity.get("model_name"),
        "model_version": entity.get("model_version"),
        "embedding_dim": entity.get("embedding_dim"),
        "extractor_version": entity.get("extractor_version"),
    }
