...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("segmentation_version", sa.String(length=64), nullable=False, server_default="unknown"),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("CURRENT_TIMESTAMP")),
    ...
    op.create_table(
        ...
        sa.Column("model_version", sa.String(length=128), nullable=False, server_default="unknown"),
